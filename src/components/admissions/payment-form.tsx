...
export function PaymentForm({ invoiceId, invoiceNumber, balance, onSuccess, onCancel }: PaymentFormProps) {
  ...
  if (success) {
    return (
      <Card className="w-full max-w-md mx-auto border border-slate-200 shadow-2xl rounded-sm overflow-hidden bg-white animate-in zoom-in-95 duration-300">
  ...
  return (
    <div className="space-y-8">
      <div className="bg-[#0f172a] p-8 text-white rounded-sm border-b border-white/10 shadow-lg">
